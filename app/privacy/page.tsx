        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            <p className="text-gray-600 leading-relaxed mb-4">
              Machikon ALICE（以下「当社」といいます）は、本ウェブサイト上で提供するサービス（以下「本サービス」といいます）における、
              ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」といいます）を定めます。
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-gray-800">第1条（個人情報）</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-gray-800">第2条（個人情報の収集方法）</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-gray-800">第3条（個人情報を収集・利用する目的）</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-gray-800">第4条（利用目的の変更）</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-gray-800">第5条（個人情報の第三者提供）</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-gray-800">第6条（個人情報の開示）</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-gray-800">第7条（個人情報の訂正および削除）</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-gray-800">第8条（個人情報の利用停止等）</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-gray-800">第9条（プライバシーポリシーの変更）</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-gray-800">第10条（お問い合わせ窓口）</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              本ポリシーに関するお問い合わせは、下記の窓口までお願いいたします。
            </p>
            <div className="bg-brand-gray-light p-6 rounded-lg">
              <p className="text-gray-800 font-medium mb-2">Machikon ALICE 個人情報お問い合わせ窓口</p>
              <p className="text-gray-600">メールアドレス: privacy@machikon-alice.example.com</p>
            </div>
          </section>
